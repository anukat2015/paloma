...
public class ProfileResource {
    ...
    @RequestMapping(value = "/rest/profile/createProfile",
    ...
    @RequestMapping(value = "/rest/contact/saveContact/{id}",
            method = RequestMethod.POST,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/rest/profile/saveSkill/{id}",
            method = RequestMethod.POST,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/rest/profile/saveCareer/{id}",
            method = RequestMethod.POST,
            consumes = MediaType.APPLICATION_JSON_VALUE)
